import { AssetLoaderChain, createAtlas, getFileName, joinAtlas, loadImage } from '../utils/assetLoader'
import { animations, type characterNames } from '@/constants/animations'
...
export const assets = {
	...
	characters: await characterLoader.load<characterNames>(import.meta.glob('./../../assets/characters/**/*.png', { eager: true })),
