...
import { battleState, despawnEntities, dungeonState, ecs, overworldState } from './globals/init'
...
import { allowPlayerToExit, exitDungeon, isPlayerInside, setDungeonState, spawnDungeon } from './stateDungeon/spawnDungeon'
