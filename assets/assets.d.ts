...
type characters = 'angelOfDeath' | 'bandit' | 'banditLeader' | 'banditOldMan' | 'bat' | 'goblin' | 'howard' | 'lumberjack' | 'orc' | 'paladin' | 'wolf'
type fonts = 'm5x7'
type items = 'campfire'
...
type ui = 'arrowDown' | 'arrowDownSelected' | 'arrowLeft' | 'arrowLeftSelected' | 'arrowRight' | 'arrowRightSelected' | 'arrowUp' | 'arrowUpSelected' | 'battleIcon' | 'boots' | 'dialogIcon' | 'frameBig' | 'framedisplay' | 'frameornate' | 'healthbar' | 'healthfull' | 'houseIcon' | 'inventory' | 'itemspot' | 'nodeIcon' | 'smallNodeIcon' | 'textbox'
