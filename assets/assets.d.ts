...
type characters = 'angelOfDeath' | 'bandit' | 'banditLeader' | 'banditOldMan' | 'bat' | 'battleEffects' | 'bear' | 'gnomeForest' | 'goblin' | 'howard' | 'lumberjack' | 'orc' | 'paladin' | 'wolf'
