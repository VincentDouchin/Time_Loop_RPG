...
type ui = 'arrowDown' | 'arrowDownSelected' | 'arrowLeft' | 'arrowLeftSelected' | 'arrowRight' | 'arrowRightSelected' | 'arrowUp' | 'arrowUpSelected' | 'battleIcon' | 'boots' | 'dialogIcon' | 'frameBig' | 'framebordered' | 'framedisplay' | 'frameornate' | 'frameparchment' | 'healthbar' | 'healthfull' | 'houseIcon' | 'hpbar' | 'inventory' | 'itemspot' | 'label' | 'nodeIcon' | 'smallNodeIcon' | 'textbox' | 'textboxbottom'
