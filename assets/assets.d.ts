...
type ui = 'arrowDown' | 'arrowDownSelected' | 'arrowLeft' | 'arrowLeftSelected' | 'arrowRight' | 'arrowRightSelected' | 'arrowUp' | 'arrowUpSelected' | 'battleIcon' | 'boots' | 'dialogIcon' | 'frameBig' | 'frameborder' | 'framebordered' | 'framedisplay' | 'frameornate' | 'frameparchment' | 'healthbar' | 'healthfull' | 'houseIcon' | 'hpbar' | 'inventory' | 'itemspot-selected' | 'itemspot' | 'label' | 'nodeIcon' | 'smallNodeIcon' | 'textbox' | 'textboxbottom'
