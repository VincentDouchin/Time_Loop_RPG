...
type ui = 'arrowDown' | 'arrowDownSelected' | 'arrowLeft' | 'arrowLeftSelected' | 'arrowRight' | 'arrowRightSelected' | 'arrowUp' | 'arrowUpSelected' | 'boots' | 'frameBig' | 'framedisplay' | 'frameornate' | 'healthbar' | 'healthfull' | 'inventory' | 'itemspot' | 'textbox'
